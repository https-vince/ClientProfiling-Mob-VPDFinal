...
class EditEthicalConductPolicyScreen extends StatefulWidget {
  final List<Map<String, String>> entries;
  const EditEthicalConductPolicyScreen({Key? key, required this.entries}) : super(key: key);

  @override
  State<EditEthicalConductPolicyScreen> createState() => _EditEthicalConductPolicyScreenState();
}

class _EditEthicalConductPolicyScreenState extends State<EditEthicalConductPolicyScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const Text('Edit Ethical Conduct and Accountability Policy',
