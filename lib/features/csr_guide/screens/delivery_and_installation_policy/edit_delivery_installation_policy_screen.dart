...
class EditDeliveryInstallationPolicyScreen extends StatefulWidget {
  final List<Map<String, String>> entries;
  const EditDeliveryInstallationPolicyScreen({Key? key, required this.entries}) : super(key: key);

  @override
  State<EditDeliveryInstallationPolicyScreen> createState() => _EditDeliveryInstallationPolicyScreenState();
}

class _EditDeliveryInstallationPolicyScreenState extends State<EditDeliveryInstallationPolicyScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const Text('Edit Delivery and Installation Policy',
