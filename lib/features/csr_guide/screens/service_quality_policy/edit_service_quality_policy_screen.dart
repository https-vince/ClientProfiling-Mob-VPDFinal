...
class EditServiceQualityPolicyScreen extends StatefulWidget {
  final List<Map<String, String>> entries;

  const EditServiceQualityPolicyScreen({Key? key, required this.entries})
      : super(key: key);

  @override
  State<EditServiceQualityPolicyScreen> createState() =>
      _EditServiceQualityPolicyScreenState();
}

class _EditServiceQualityPolicyScreenState
    extends State<EditServiceQualityPolicyScreen> {
