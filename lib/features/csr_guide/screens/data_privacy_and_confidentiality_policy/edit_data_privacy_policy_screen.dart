...
class EditDataPrivacyPolicyScreen extends StatefulWidget {
  final List<Map<String, String>> entries;

  const EditDataPrivacyPolicyScreen({Key? key, required this.entries})
      : super(key: key);

  @override
  State<EditDataPrivacyPolicyScreen> createState() =>
      _EditDataPrivacyPolicyScreenState();
}

class _EditDataPrivacyPolicyScreenState
    extends State<EditDataPrivacyPolicyScreen> {
  ...
  void initState() {
    ...
    _titleControllers =
        initial.map((e) => TextEditingController(text: e['title'])).toList();
    _bodyControllers =
        initial.map((e) => TextEditingController(text: e['body'])).toList();
  }
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  'Edit Data Privacy and Confidentiality Policy',
                  style: TextStyle(
                    fontSize: 20,
                        ...
                        TextFormField(
                          ...
                          validator: (v) =>
                              (v == null || v.trim().isEmpty)
                                  ? 'Required'
                                  : null,
                          decoration: _inputDecoration('Enter content...'),
                        ),
