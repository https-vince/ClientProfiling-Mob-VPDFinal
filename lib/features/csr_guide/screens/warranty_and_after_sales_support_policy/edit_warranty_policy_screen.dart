...
class EditWarrantyPolicyScreen extends StatefulWidget {
  final List<Map<String, String>> entries;
  const EditWarrantyPolicyScreen({Key? key, required this.entries}) : super(key: key);

  @override
  State<EditWarrantyPolicyScreen> createState() => _EditWarrantyPolicyScreenState();
}

class _EditWarrantyPolicyScreenState extends State<EditWarrantyPolicyScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const Text('Edit Warranty and After-Sales Support Policy',
