...
import 'edit_warranty_policy_screen.dart';

class WarrantyPolicyScreen extends StatefulWidget {
  const WarrantyPolicyScreen({Key? key}) : super(key: key);

  @override
  State<WarrantyPolicyScreen> createState() => _WarrantyPolicyScreenState();
}

class _WarrantyPolicyScreenState extends State<WarrantyPolicyScreen> {
  List<Map<String, String>> _entries = [];

  Future<void> _openEditScreen() async {
    final result = await Navigator.of(context).push<List<Map<String, String>>>(
      MaterialPageRoute(
        builder: (_) => EditWarrantyPolicyScreen(entries: _entries),
      ),
    );
