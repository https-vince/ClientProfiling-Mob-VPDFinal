...
class EditProductIntroductionScreen extends StatefulWidget {
  final List<Map<String, String>> entries;

  const EditProductIntroductionScreen({Key? key, required this.entries})
      : super(key: key);

  @override
  State<EditProductIntroductionScreen> createState() =>
      _EditProductIntroductionScreenState();
}

class _EditProductIntroductionScreenState
    extends State<EditProductIntroductionScreen> {
                    ...
                    children: [
                      for (int i = 0;
                        ...
                        TextFormField(
                          ...
                          decoration:
                              _inputDecoration('Enter title (optional)...'),
                        ),
