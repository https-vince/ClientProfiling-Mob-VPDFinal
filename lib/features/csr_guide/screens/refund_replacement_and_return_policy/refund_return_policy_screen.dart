...
import 'edit_refund_return_policy_screen.dart';

class RefundReturnPolicyScreen extends StatefulWidget {
  const RefundReturnPolicyScreen({Key? key}) : super(key: key);

  @override
  State<RefundReturnPolicyScreen> createState() => _RefundReturnPolicyScreenState();
}

class _RefundReturnPolicyScreenState extends State<RefundReturnPolicyScreen> {
  List<Map<String, String>> _entries = [];

  Future<void> _openEditScreen() async {
    final result = await Navigator.of(context).push<List<Map<String, String>>>(
      MaterialPageRoute(
        builder: (_) => EditRefundReturnPolicyScreen(entries: _entries),
      ),
    );
