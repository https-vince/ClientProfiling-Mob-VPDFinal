...
class EditRefundReturnPolicyScreen extends StatefulWidget {
  final List<Map<String, String>> entries;
  const EditRefundReturnPolicyScreen({Key? key, required this.entries}) : super(key: key);

  @override
  State<EditRefundReturnPolicyScreen> createState() => _EditRefundReturnPolicyScreenState();
}

class _EditRefundReturnPolicyScreenState extends State<EditRefundReturnPolicyScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const Text('Edit Refund, Replacement, and Return Policy',
