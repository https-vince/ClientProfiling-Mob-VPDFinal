...
class EditComplaintHandlingScreen extends StatefulWidget {
  final List<Map<String, String>> entries;

  const EditComplaintHandlingScreen({Key? key, required this.entries})
      : super(key: key);

  @override
  State<EditComplaintHandlingScreen> createState() =>
      _EditComplaintHandlingScreenState();
}

class _EditComplaintHandlingScreenState
    extends State<EditComplaintHandlingScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const Text(
                  'Edit Complaint Handling and Resolution Policy',
                  style: TextStyle(
                    fontSize: 20,
