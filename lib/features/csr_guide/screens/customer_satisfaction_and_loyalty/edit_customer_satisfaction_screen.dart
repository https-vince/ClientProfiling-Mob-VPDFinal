...
class EditCustomerSatisfactionScreen extends StatefulWidget {
  final List<Map<String, String>> entries;
  const EditCustomerSatisfactionScreen({Key? key, required this.entries}) : super(key: key);

  @override
  State<EditCustomerSatisfactionScreen> createState() => _EditCustomerSatisfactionScreenState();
}

class _EditCustomerSatisfactionScreenState extends State<EditCustomerSatisfactionScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                const Text('Edit Customer Satisfaction and Loyalty',
